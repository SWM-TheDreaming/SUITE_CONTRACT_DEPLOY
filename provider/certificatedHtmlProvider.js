...
export const certificatedHtmlProvider = (
  ...
  const mainLogoBase64 = encodeImageToBase64(
    path.join(__dirname, "../public/images/main-logo.png")
  );
  const stringLogoBase64 = encodeImageToBase64(
    path.join(__dirname, "../public/images/string-logo.png")
  );
  const calendarBase64 = encodeImageToBase64(
    path.join(__dirname, "../public/images/calendar.png")
  );
  const clapBase64 = encodeImageToBase64(
    path.join(__dirname, "../public/images/clap.png")
  );

  const trophyBase64 = encodeImageToBase64(
    path.join(__dirname, "../public/images/trophy.png")
  );

  return `
  <div style="width: 842px; height: 595px; position: relative; background: rgba(5, 9, 83); overflow:hidden">
  <image style="left: 621px; top: 13px; position: absolute;" src="${mainLogoBase64}"></image>  
  <image style="left: 58px; top: 13px; position: absolute; z-index: 10;" src="${stringLogoBase64}"></image>  
  <img style="left: 492px; top: 407px; position: absolute;" src="${calendarBase64}" />
  ...
  <img style="width: 126px; height: 127px; left: 702.91px; top: 283px; position: absolute; transform: rotate(5.38deg); transform-origin: 0 0; opacity: 0.80" src="${clapBase64}" />
  ...
  <div style="width: 489px; height: 24px; left: 58px; top: 171px; position: absolute; color: black; font-size: 18px; font-family: Inter; font-weight: 700; word-wrap: break-word">${title}</div>
  ...
  <image style="left: 131px; top: 217px; position: absolute;" src="${trophyBase64}"></image>
  ...
  <div style="width: 163px; height: 44px; left: 78px; top: 320px; position: absolute"><span style="color: white; font-size: 24px; font-family: Inter; font-weight: 700; word-wrap: break-word">미션 : ${ownMissionRate}%<br/></span><span style="color: white; font-size: 12px; font-family: Inter; font-weight: 700; word-wrap: break-word">계약서상 미션 달성률 - ${minMissionRate}%</span></div>
  <div style="width: 163px; height: 44px; left: 296px; top: 320px; position: absolute"><span style="color: white; font-size: 24px; font-family: Inter; font-weight: 700; word-wrap: break-word">출석 : ${ownAttendanceRate}%<br/></span><span style="color: white; font-size: 12px; font-family: Inter; font-weight: 700; word-wrap: break-word">계약서상 출석률 - ${minAttendanceRate}%</span></div>
  <div style="width: 421px; height: 23px; left: 58px; top: 230px; position: absolute; color: black; font-size: 16px; font-family: Inter; font-weight: 700; word-wrap: break-word">${memberName} 님, 성공적으로 체크아웃 하신 것을 축하드립니다.</div>
